...
// Workshop: Wednesday April 8 2026, 08:00 CLT (UTC-3) = 11:00 UTC
const WORKSHOP_DATE = new Date("2026-04-08T11:00:00Z");
  ...
  return (
    <div style={{
      ...
      <div className="flex flex-col sm:flex-row sm:items-center" style={{ gap: "10px", marginBottom: "20px" }}>
        ...
        <span style={{ color: "rgba(255,255,255,0.5)", fontSize: "11px" }}>Miér 8 abr · 8:00–10:00 h Chile</span>
      </div>
