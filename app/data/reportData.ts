...
export const basicRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 10, name: "Venancio Fernando Pereira Henriques",email: "venancio.pereira@giuntipsy.com",        progress: 75,  certifiedCourses: 3, startDate: "2026-03-23" },
    ...
    { id: 23, name: "Arturo Cervera",                     email: "arturo.cervera@giuntipsy.com",          progress: 2,   certifiedCourses: 0, startDate: "2026-03-28" },
