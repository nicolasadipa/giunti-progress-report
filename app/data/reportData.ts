...
export const basicRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 3,  name: "Venancio Fernando Pereira Henriques",email: "venancio.pereira@giuntipsy.com",        progress: 100, certifiedCourses: 4, startDate: "2026-03-23" },
    ...
    { id: 7,  name: "Marco Fortini",                      email: "marco.fortini@giuntipsy.com",           progress: 100, certifiedCourses: 4, startDate: "2026-03-19" },
    { id: 8,  name: "David Fernández",                    email: "david.fernandez@giuntipsy.com",         progress: 100, certifiedCourses: 4, startDate: "2026-03-20" },
    { id: 9,  name: "Stefano Scotto",                     email: "stefano.scotto@giuntipsy.com",          progress: 100, certifiedCourses: 4, startDate: "2026-03-19" },
    { id: 10, name: "Jorge Ramón Gómez",                  email: "jorge.ramon@giuntipsy.com",             progress: 81,  certifiedCourses: 3, startDate: "2026-03-24" },
    { id: 11, name: "José Sales Grade",                   email: "jose.grade@giuntipsy.com",              progress: 75,  certifiedCourses: 3, startDate: "2026-03-20" },
    { id: 12, name: "Sandra Contiero",                    email: "sandra.contiero@giuntipsy.com",         progress: 75,  certifiedCourses: 3, startDate: "2026-03-19" },
    { id: 13, name: "Sandra María Redondo Fernández",     email: "sandra.redondofernandez@giuntipsy.com", progress: 75,  certifiedCourses: 3, startDate: "2026-03-23" },
    { id: 14, name: "Luca Mandolesi",                     email: "luca.mandolesi@giuntipsy.com",          progress: 53,  certifiedCourses: 2, startDate: "2026-03-19" },
    { id: 15, name: "Mateo Turanzas",                     email: "mateo.turanzas@giuntipsy.com",          progress: 38,  certifiedCourses: 1, startDate: "2026-03-26" },
    { id: 16, name: "Caterina Perri",                     email: "caterina.perri@giuntipsy.com",          progress: 38,  certifiedCourses: 1, startDate: "2026-03-23" },
    { id: 17, name: "Álvaro Morales de Vera",             email: "alvaro.morales@giuntipsy.com",          progress: 32,  certifiedCourses: 1, startDate: "2026-03-19" },
    { id: 18, name: "Irene Guarneri",                     email: "irene.guarneri@giuntipsy.com",          progress: 29,  certifiedCourses: 1, startDate: "2026-03-24" },
    { id: 19, name: "Jordi Bretos",                       email: "jordi.bretos@giuntipsy.com",            progress: 10,  certifiedCourses: 0, startDate: "2026-03-23" },
    { id: 20, name: "Arturo Cervera",                     email: "arturo.cervera@giuntipsy.com",          progress: 9,   certifiedCourses: 0, startDate: "2026-03-28" },
    { id: 21, name: "Iker Pardo",                         email: "iker.pardo@giuntipsy.com",              progress: 8,   certifiedCourses: 0, startDate: "2026-03-30" },
...
export const intermediateRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 4,  name: "David Fernández",                    email: "david.fernandez@giuntipsy.com",         progress: 53,  certifiedCourses: 3, startDate: "2026-03-26" },
    ...
    { id: 7,  name: "Giuseppe Agrusti",                   email: "giuseppe.agrusti@giuntipsy.com",        progress: 39,  certifiedCourses: 2, startDate: "2026-03-27" },
    { id: 8,  name: "Stefano Cutello",                    email: "stefano.cutello@giuntipsy.com",         progress: 18,  certifiedCourses: 1, startDate: "2026-03-24" },
    { id: 9,  name: "Mateo Turanzas",                     email: "mateo.turanzas@giuntipsy.com",          progress: 16,  certifiedCourses: 1, startDate: "2026-03-20" },
    { id: 10, name: "José Sales Grade",                   email: "jose.grade@giuntipsy.com",              progress: 11,  certifiedCourses: 0, startDate: "2026-03-24" },
    ...
    { id: 14, name: "Tommaso Salsetta",                   email: "tommaso.salsetta@giuntipsy.com",        progress: 0,   certifiedCourses: 0, startDate: null },
    ...
    { id: 17, name: "Andrea Damiano",                     email: "andrea.damiano@giuntipsy.com",          progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 18, name: "Arturo Cervera",                     email: "arturo.cervera@giuntipsy.com",          progress: 0,   certifiedCourses: 0, startDate: null },
    ...
    { id: 21, name: "Cosimo Aleo",                        email: "cosimo.aleo@giuntipsy.com",             progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 22, name: "Matteo Rosati",                      email: "matteo.rosati@giuntipsy.com",           progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 23, name: "Venancio Fernando Pereira Henriques",email: "venancio.pereira@giuntipsy.com",        progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 24, name: "Iker Pardo",                         email: "iker.pardo@giuntipsy.com",              progress: 0,   certifiedCourses: 0, startDate: null },
