...
export const basicRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 15, name: "Sandra María Redondo Fernández",     email: "sandra.redondofernandez@giuntipsy.com", progress: 75,  certifiedCourses: 3, startDate: "2026-03-23" },
...
export const intermediateRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 6,  name: "Giuseppe Agrusti",                   email: "giuseppe.agrusti@giuntipsy.com",        progress: 66,  certifiedCourses: 4, startDate: "2026-03-27" },
    { id: 7,  name: "Venancio Fernando Pereira Henriques",email: "venancio.pereira@giuntipsy.com",        progress: 52,  certifiedCourses: 3, startDate: "2026-04-01" },
    { id: 8,  name: "Carlo Sortino",                      email: "carlo.sortino@giuntipsy.com",           progress: 50,  certifiedCourses: 3, startDate: "2026-03-26" },
    { id: 9,  name: "Álvaro Morales de Vera",             email: "alvaro.morales@giuntipsy.com",          progress: 49,  certifiedCourses: 2, startDate: "2026-03-19" },
