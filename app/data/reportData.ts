...
export const basicRoute: RouteData = {
  ...
  totalCourses: 4,
  participants: [
    { id: 1,  name: "Stefano Scotto",                     email: "stefano.scotto@giuntipsy.com",          progress: 100, certifiedCourses: 4, startDate: "2026-03-19" },
    ...
    { id: 6,  name: "David Fernández",                    email: "david.fernandez@giuntipsy.com",         progress: 100, certifiedCourses: 4, startDate: "2026-03-20" },
    { id: 7,  name: "Ilaria Sartorio",                    email: "ilaria.sartorio@giuntipsy.com",         progress: 100, certifiedCourses: 4, startDate: "2026-03-20" },
    { id: 8,  name: "José Sales Grade",                   email: "jose.grade@giuntipsy.com",              progress: 100, certifiedCourses: 4, startDate: "2026-03-20" },
    { id: 9,  name: "Marco Fortini",                      email: "marco.fortini@giuntipsy.com",           progress: 100, certifiedCourses: 4, startDate: "2026-03-19" },
    { id: 10, name: "Stefano Cutello",                    email: "stefano.cutello@giuntipsy.com",         progress: 100, certifiedCourses: 4, startDate: "2026-03-19" },
    ...
    { id: 14, name: "Irene Guarneri",                     email: "irene.guarneri@giuntipsy.com",          progress: 75,  certifiedCourses: 3, startDate: "2026-03-24" },
    { id: 15, name: "Mateo Turanzas",                     email: "mateo.turanzas@giuntipsy.com",          progress: 57,  certifiedCourses: 2, startDate: "2026-03-26" },
    { id: 16, name: "Iker Pardo",                         email: "iker.pardo@giuntipsy.com",              progress: 56,  certifiedCourses: 2, startDate: "2026-03-30" },
    { id: 17, name: "Luca Mandolesi",                     email: "luca.mandolesi@giuntipsy.com",          progress: 53,  certifiedCourses: 2, startDate: "2026-03-19" },
...
export const intermediateRoute: RouteData = {
  ...
  participants: [
    ...
    { id: 2,  name: "Duccio Galli",                       email: "duccio.galli@giuntipsy.com",            progress: 100, certifiedCourses: 6, startDate: "2026-03-20" },
    { id: 3,  name: "Luca Mandolesi",                     email: "luca.mandolesi@giuntipsy.com",          progress: 71,  certifiedCourses: 4, startDate: "2026-03-23" },
    { id: 4,  name: "David Fernández",                    email: "david.fernandez@giuntipsy.com",         progress: 66,  certifiedCourses: 4, startDate: "2026-03-26" },
    ...
    { id: 14, name: "Venancio Fernando Pereira Henriques",email: "venancio.pereira@giuntipsy.com",        progress: 5,   certifiedCourses: 0, startDate: "2026-04-01" },
    { id: 15, name: "Arturo Cervera",                     email: "arturo.cervera@giuntipsy.com",          progress: 3,   certifiedCourses: 0, startDate: "2026-03-30" },
    { id: 16, name: "Tommaso Salsetta",                   email: "tommaso.salsetta@giuntipsy.com",        progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 17, name: "Dionisio Torre",                     email: "dionisio.torre@giuntipsy.com",          progress: 0,   certifiedCourses: 0, startDate: null },
    { id: 18, name: "Iker Pardo",                         email: "iker.pardo@giuntipsy.com",              progress: 0,   certifiedCourses: 0, startDate: null },
